        ...
        public static void Main(string[] args) {
            try {
                ...
                for (int panoramaPartId = 0; panoramaPartId < Config.Angles.Length; panoramaPartId++) {
                    ...
                    using (var fs1 = new FileStream(Config.OverlapStatePaths[panoramaPartId], FileMode.Create))
                    using (var writer1 = new BinaryWriter(fs1))
                    using (var fs2 = new FileStream(Config.RatePaths[panoramaPartId], FileMode.Create))
